...
void autonomous() 
{
    ...
    chassis.setPose(0, 0, 0);
    chassis.moveToPose(0.0, 15.0, 0, 4000, { .forwards = false }, false);
    ...
    chassis.setPose(0, 0, 0);
    chassis.moveToPose(24.0, -12.0, -26.565, 4000, {.forwards = false}, false);
    mogo_mech.set_value(false);
    pros::delay(500);

    chassis.setPose(0, 0, 0);
    chassis.moveToPose(1.0, -1.0, -26.565, 1000, {.forwards = false}, false);

}               // expand this to score the most poitns in skills, needs heavy testing and high priority, do this first
